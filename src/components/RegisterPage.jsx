...
const RegisterPage = () => {
  ...
  const { input, handleChange, handleRegister } = state;

  return (
    <div>
      <>
        {/* component */}
        <section className="pb-[200px] mt-[150px] max-w-[1240px] mx-auto relative text-neutral">
          <div className="flex max-md:flex-wrap max-md:px-4 gap-8 max-md:gap-[60px] justify-center  items-center">
            <div className="w-full self-stretch flex flex-col justify-evenly  lg:w-1/2 xl:w-6/12 px-8 bg-[#E6EEFF] py-8 rounded-xl">
            ...
            <div className="w-full lg:w-1/2 xl:w-5/12 max-md:px-4">
              <div className="bg-white relative rounded-2xl p-8 sm:p-12 shadow-lg">
                <form onSubmit={handleRegister} className="space-y-3">
                  <h3 className="text-2xl font-medium">Create New Account</h3>
                  ...
                  <div className="form-control">
                    <label className="cursor-pointer label  mt-8 flex justify-end gap-4 flex-row-reverse">
                  ...
                  <p className="text-center pt-[50px]">
                    ...
                    <Link to="/dashboard/login" className="text-primary">
                      Login Here
                    </Link>{" "}
                  </p>
                </form>
